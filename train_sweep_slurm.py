...
def main(sweep_id):
    ...
    def train():
        ...
        save_model_path = f"svtr_vn_240909_{sweep_id}.pth"
        torch.save(model.state_dict(), save_model_path)
    
    print(f"agent 전 sweep_id: {sweep_id}")
    wandb.agent(sweep_id, function=train, count=5, entity = "youngjun-hwang", project="slurm-test")
