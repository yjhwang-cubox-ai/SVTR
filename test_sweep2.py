        ...
        if (epoch + 1) % 1 == 0:
            ...
            with torch.no_grad():
                for batch in tqdm.tqdm(val_dataloader):
                    ...
                    # wandb image logging
                    img_names = ['testimg/word.jpg', 'testimg/word2.jpg', 'testimg/word3.jpg']
...
if __name__ == "__main__":
    ...
    train_files = [
        ...
        "/data/TNGoDataset/4_TNGo4/annotation.json",
        "/data/TNGoDataset/5_Employee_Text/annotation.json",
    ]
    val_files = [
