...
class SVTRNet(nn.Module):
    def __init__(
        self,
        img_size=[32, 100], #Tiny: [32, 100], Large:[48, 160]
        in_channels=3,
        embed_dim=[64, 128, 256], #Tiny: [64, 128, 256], Large: [192, 256, 384]
        depth=[3,6,3], #Tiny: [3, 6, 3], Large: [3, 9, 9]
        num_heads=[2,4,8], #Tiny: [2, 4, 8], Large: [6, 8, 6]
        mixer=["Local"] * 6 + ["Global"] * 6, # Local atten, Global atten, Conv #Tiny: ["Local"] * 6 + ["Global"] * 6, Large: ["Local"] * 10 + ["Global"] * 11
        ...
        sub_norm="nn.LayerNorm",
        epsilon=1e-6,
        out_channels=192, #Tiny: 192, Large: 384
